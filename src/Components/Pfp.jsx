...
function Pfp({ size, data, name, color, onClick }) {
  let backgroundColor;
  ...
  return (
    ...
    <div
      ...
      rounded-full border-2 border-zinc-400 cursor-pointer text-[${size}px] bg-[${backgroundColor}] font-semibold flex items-center justify-center`}
    >
      {name?.charAt(0)}
    </div>
  );
